...
// (internal/certmgr) and the DNS credentials it stores, so only the domain is
// persisted here. It is the single definition of those keys; both the early
// write (stepServices) and the full install-state write derive from it.
