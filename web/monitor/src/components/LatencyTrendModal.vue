...
import { carrierTargets, type LatencySnapshot, type PingTarget } from "../types";
...
// single flat list of nine lines cannot express either. This is the one thing
// this chart has that the others do not.
...
<template>
  <TrendShell
    :title="nodeName"
    :subtitle="`Carrier probes · ${spanLabel}`"
